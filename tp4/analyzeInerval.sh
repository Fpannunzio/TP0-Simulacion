...
DATA=output/analyze_interval.json
...
mvn -f tp4_java exec:java -Dexec.mainClass=ar.edu.itba.simulacion.tp4.marsMission.AnalyzeInterval -Dexec.args="$CONFIG" -q || exit
