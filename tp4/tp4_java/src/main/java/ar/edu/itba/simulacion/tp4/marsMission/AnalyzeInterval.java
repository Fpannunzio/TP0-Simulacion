...
public final class AnalyzeInterval {
    ...
    public static final double  MARS_ORBIT              = 2.2799e11;
    ...
    public static final int     INTERVAL_SECONDS        = 5_500 * 24 * 60 * 60;  // 5500 dias

    public static final double DISTANCE_TOLERANCE = MARS_ORBIT / 1_000;

    public static final int MAX_UNCHANGED_MIN_DIST = 1_000;

    public static final int INITIAL_TOLERANCE = 100;
